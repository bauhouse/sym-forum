			...
			<xsl:otherwise>
				<div class="calendar-head">
					<ul class="calendar-menu">
						<li><a href="{$root}/calendar/year/{$previous-year-url}/">Previous Year</a></li>
						<li><a href="{$root}/calendar/year/{$next-year-url}/">Next Year</a></li>
						<li>
							...
							<a href="{$root}/calendar/year/today/">Today</a>
						</li>
						...
						<li class="current"><a href="{$root}/calendar/year/{$current-date-url}">Year</a></li>
					</ul>
    ...
    <xsl:choose>
        ...
        <xsl:when test="$index &gt; $start - 1">
            <td>
            	...
            	<span>
            		<a href="{$root}/calendar/year/{$year}/{$month}/{$day-dd}/">
						<xsl:choose>
